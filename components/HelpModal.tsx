...
// Extracted Section component to avoid re-definition and fix TypeScript inference for children
...
const Section: React.FC<SectionProps> = ({ title, icon, children, theme }) => (
